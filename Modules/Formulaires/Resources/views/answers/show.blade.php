...
@section('title')
    Gestion des champs du formulaire : {{ $formulaire->title }} ({{ $formulaire->uuid }})
@endsection
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('answers.create', $formulaire->id) }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
							<i class="fa fa-file-text-o" aria-hidden="true"></i>
							<span>Créer une réponse</span>
						</span>
                        </a>
...
@push('js')
    {!!
        datatable(route('datatables.answers', $formulaire->id),
        array('nom'=>'Nom','prenom'=>'Prenom','content'=>'Contenu', 'ip'=>'Adresse IP', 'handled'=>'Traité', 'created_at'=>'Créé le', 'updated_at'=>'Mis à jour le'))
    !!}
    {!! actions_groupe_js('answers','answers') !!}
@endpush
