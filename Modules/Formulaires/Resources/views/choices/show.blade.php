...
@section('title')
    Gestion des valeurs du champ : {{ $field->name }}
@endsection
...
@section('nav')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{ route('fields.show', $field->formulaire->id) }}" class="m-nav__link">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('choices.create', $field->id) }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
							<i class="fa fa-file-text-o" aria-hidden="true"></i>
							<span>Créer un choix</span>
						</span>
                        </a>
...
@push('js')
    {!!
        datatable(route('datatables.choices', $field->id),
        array('label'=>'Label', 'value'=>'Valeur', 'selected'=>'Sélectionné par défaut', 'actif'=>'Actif', 'created_at'=>'Créé le', 'updated_at'=>'Mis à jour le'))
    !!}
    {!! actions_groupe_js('choices', 'choices') !!}
