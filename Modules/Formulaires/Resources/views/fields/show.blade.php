            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('fields.create', $formulaire->id) }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
...
@push('js')
    {!!
        datatable(route('datatables.fields', $formulaire->id),
        array('name'=>'Nom', 'label_bo'=>'Label BO', 'type'=>'Type', 'backoffice'=>'BO', 'actif'=>'Actif'),
        "reorder")
    !!}
    {!! actions_groupe_js('fields','fields') !!}
@endpush
