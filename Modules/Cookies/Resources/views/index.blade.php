        ...
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('cookies.create') }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
            ...
            <div class="m-alert m-alert--icon alert alert-danger" role="alert">
                ...
                <div class="m-alert__text">
                    <strong>Attention !</strong> Il faut activer uniquement un seul modèle.
                </div>
            </div>
...
@push('js')
    {!!
        datatable(route('datatables.cookies'),
        array('title'=>'Titre', 'actif'=>'Actif', 'created_at'=>'Créé le', 'updated_at'=>'Mis à jour le'))
    !!}
    {!! actions_groupe_js('cookies') !!}
@endpush
