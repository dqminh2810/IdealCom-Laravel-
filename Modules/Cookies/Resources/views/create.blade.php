    ...
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="#" class="m-nav__link">
                <span class="m-nav__link-text">Créer un modèle</span>
            </a>
        </li>
    </ul>
@endsection
...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body text-center">
            ...
            {{ Form::open(array('url' => route('cookies.store'))) }}
            ...
            <div class="form-group">
                ...
                {{ Form::radio('position', 'bottom', true) }} Bottom
                <span> - </span>
            ...
            <div class="form-group">
                ...
                {{ Form::text('banner_text', old('banner_text'), array('class' => 'form-control', 'placeholder' => 'Nous utilisons des cookies pour optimiser votre expérience sur notre site.')) }}
            </div>

            <div class="form-group">
                {{ Form::label('button_text', 'Texte du bouton :') }}
                {{ Form::text('button_text', old('button_text'), array('class' => 'form-control', 'placeholder' => 'Accepter')) }}
            </div>

            <div class="form-group">
                {{ Form::label('link', 'Adresse du lien pour en savoir plus sur l\'utilisation des cookies :') }}
                {{ Form::text('link', old('link'), array('class' => 'form-control', 'placeholder' => 'https://cookiesandyou.com/')) }}
            </div>

            <div class="form-group">
                {{ Form::label('banner_color', 'Couleur de la bannière :') }}
                {{ Form::text('banner_color', old('banner_color'), array('class' => 'form-control', 'placeholder' => '#edeff5')) }}
            </div>

            <div class="form-group">
                {{ Form::label('banner_text_color', 'Couleur du texte dans la bannière :') }}
                {{ Form::text('banner_text_color', old('banner_text_color'), array('class' => 'form-control', 'style'=>'height: 50px', 'placeholder' => '#8383a8')) }}
            </div>

            <div class="form-group">
                {{ Form::label('button_color', 'Couleur du bouton :') }}
                {{ Form::text('button_color', old('button_color'), array('class' => 'form-control', 'style'=>'height: 50px', 'placeholder' => '#4b81e8')) }}
            </div>

            <div class="form-group">
                {{ Form::label('button_text_color', 'Couleur du texte dans le bouton :') }}
                {{ Form::text('button_text_color', old('button_text_color'), array('class' => 'form-control', 'style'=>'height: 50px', 'placeholder' => '#ffffff')) }}
            </div>
