            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('subscribers.create') }}" id='creer_subscriber' class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
...
@endsection
@push('js')
    {!! datatable(route('datatables.subscribers'),
        array('subscriber_name'=>'Nom', 'email'=>'Email', 'actif'=>'Actif')) !!}}}
    {!! actions_groupe_js('subscribers') !!}
@endpush