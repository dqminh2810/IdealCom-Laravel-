...
@section('title')
    Editer le domaine : {{ $domain->display_name }}
@endsection
    ...
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="#" class="m-nav__link">
                <span class="m-nav__link-text">Editer un domaine</span>
            </a>
        </li>
    </ul>
@endsection
...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body text-center">
            ...
            {{ Form::model($domain, array('url' => route('domains.update', $domain->id), 'method'=>'PUT')) }}
            ...
            <div class="form-group">
                ...
                {{ Form::text('google_webmastertool', old('google_analytics'), array('class' => 'form-control')) }}
            </div>
