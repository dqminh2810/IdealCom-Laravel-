...
@section('nav')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="#" class="m-nav__link">
                <span class="m-nav__link-text">Créer une photo</span>
            </a>
        </li>
    </ul>
@endsection
...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body text-center">
            ...
            {{ Form::open(array('url' => route('photos.store'), 'files' => true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::file('photo', array('class' => 'form-control', 'required', 'accept' => '.jpeg, .png, .bmp, .gif, .svg')) }}
            </div>
            ...
            {{ Form::submit('Créer une nouvelle photo', array('class' => 'btn btn-primary')) }}
