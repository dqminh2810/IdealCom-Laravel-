            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('pages.create') }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
							<i class="fa fa-file-text-o" aria-hidden="true"></i>
							<span>Créer une page de contenu</span>
						</span>
                        </a>
...
@push('js')
    {!!
        datatable(route('datatables.pages'),
        array('title'=>'Titre', 'url'=>'URL', 'created_at'=>'Créé le', 'updated_at'=>'Mis à jour le'))
    !!}
    {!! actions_groupe_js('pages') !!}
@endpush
