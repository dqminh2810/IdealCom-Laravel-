...
@section('nav')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="{{ route('pages.index') }}" class="m-nav__link">
                <span class="m-nav__link-text">Créer une page de contenu</span>
            </a>
        </li>
    </ul>
@endsection
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body text-center">
            ...
            {{ Form::open(array('url' => route('pages.store'))) }}
            ...
            <div class="form-group">
                ...
                {{ Form::url('url', old('url'), array('class' => 'form-control', 'id' => 'url', 'required')) }}
            </div>

            <div class="form-group">
                {{ Form::label('code', 'Code :') }}
                {{ Form::text('code', old('code'), array('class' => 'form-control', 'id' => 'code', 'required', 'readonly')) }}
            </div>
            ...
            {{ Form::submit('Enregistrer les modifications', array('class' => 'btn btn-primary', 'id' => 'test')) }}
